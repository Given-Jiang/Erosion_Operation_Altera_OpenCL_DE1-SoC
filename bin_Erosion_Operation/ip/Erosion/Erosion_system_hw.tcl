...
set_module_property NAME Erosion_system
set_module_property VERSION 1.0
set_module_property INTERNAL false
set_module_property GROUP Accelerators
set_module_property DISPLAY_NAME Erosion_system
set_module_property TOP_LEVEL_HDL_FILE Erosion_system.v
set_module_property TOP_LEVEL_HDL_MODULE Erosion_system
...
### SLAVE interface avs_erosion_cra
add_interface avs_erosion_cra avalon end
set_interface_property avs_erosion_cra addressAlignment DYNAMIC
set_interface_property avs_erosion_cra burstOnBurstBoundariesOnly false
set_interface_property avs_erosion_cra explicitAddressSpan 0
set_interface_property avs_erosion_cra holdTime 0
set_interface_property avs_erosion_cra isMemoryDevice false
set_interface_property avs_erosion_cra isNonVolatileStorage false
set_interface_property avs_erosion_cra linewrapBursts false
set_interface_property avs_erosion_cra maximumPendingReadTransactions 1
set_interface_property avs_erosion_cra printableDevice false
set_interface_property avs_erosion_cra readLatency 0
set_interface_property avs_erosion_cra readWaitTime 1
set_interface_property avs_erosion_cra setupTime 0
set_interface_property avs_erosion_cra timingUnits Cycles
set_interface_property avs_erosion_cra writeWaitTime 0
set_interface_property avs_erosion_cra ASSOCIATED_CLOCK clock_reset
set_interface_property avs_erosion_cra ENABLED true
add_interface_port avs_erosion_cra avs_erosion_cra_read read Input 1
add_interface_port avs_erosion_cra avs_erosion_cra_write write Input 1
add_interface_port avs_erosion_cra avs_erosion_cra_address address Input 4
add_interface_port avs_erosion_cra avs_erosion_cra_writedata writedata Input 64
add_interface_port avs_erosion_cra avs_erosion_cra_byteenable byteenable Input 8
add_interface_port avs_erosion_cra avs_erosion_cra_waitrequest waitrequest Output 1
add_interface_port avs_erosion_cra avs_erosion_cra_readdata readdata Output 64
add_interface_port avs_erosion_cra avs_erosion_cra_readdatavalid readdatavalid Output 1
...
add_file Erosion.v {SYNTHESIS SIMULATION}
