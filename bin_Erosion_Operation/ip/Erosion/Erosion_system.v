...
(
   ...
   input logic resetn,
   // AVS avs_erosion_cra
   input logic avs_erosion_cra_read,
   input logic avs_erosion_cra_write,
   input logic [3:0] avs_erosion_cra_address,
   input logic [63:0] avs_erosion_cra_writedata,
   input logic [7:0] avs_erosion_cra_byteenable,
   output logic avs_erosion_cra_waitrequest,
   output logic [63:0] avs_erosion_cra_readdata,
   output logic avs_erosion_cra_readdatavalid,
   ...
   // INST erosion of erosion_top_wrapper
   erosion_top_wrapper erosion
   (
      .clock(clock),
      .clock2x(clock2x),
      .resetn(resetn),
      .cra_irq(kernel_irqs),
      // AVS avs_cra
      .avs_cra_read(avs_erosion_cra_read),
      .avs_cra_write(avs_erosion_cra_write),
      .avs_cra_address(avs_erosion_cra_address),
      .avs_cra_writedata(avs_erosion_cra_writedata),
      .avs_cra_byteenable(avs_erosion_cra_byteenable),
      .avs_cra_waitrequest(avs_erosion_cra_waitrequest),
      .avs_cra_readdata(avs_erosion_cra_readdata),
      .avs_cra_readdatavalid(avs_erosion_cra_readdatavalid),
...
(
   ...
   erosion_function_wrapper kernel
   (
